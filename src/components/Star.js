...
const STAR_IMAGE = require( '../images/airbnb-star-selected.png' );
const STAR_SELECTED_IMAGE = require( '../images/airbnb-star.png' );
const STAR_SIZE = 40;

export default class Star extends PureComponent {
  static defaultProps = {
    selectedColor: '#00B8C8'
  };
  ...
  render() {
    ...
    const starSource = fill && selectedColor === null ? STAR_IMAGE : STAR_SELECTED_IMAGE;
